...
// UUID: 097871EF-1D42-3D2B-AE4E-1C0B47778328
//
//                           Arch: x86_64
//                Current version: 117.15.0
//          Compatibility version: 1.0.0
//                 Source version: 117.15.0.0.0
...
- (id)devicePath;
- (id)environment;
- (int)_spawnFromSelfWithPath:(id)arg1 options:(id)arg2 terminationHandler:(id)arg3 error:(void)arg4;
- (int)_spawnFromLaunchdWithPath:(id)arg1 options:(id)arg2 terminationHandler:(id)arg3 error:(void)arg4;
- (int)spawnWithPath:(id)arg1 options:(id)arg2 terminationHandler:(id)arg3 error:(void)arg4;
- (void)spawnAsyncWithPath:(id)arg1 options:(id)arg2 terminationHandler:(id)arg3 completionHandler:(void)arg4;
...
- (BOOL)startLaunchdWithDeathPort:(id)arg1 deathHandler:(id)arg2 error:(void)arg3;
...
- (void)deleteDeviceAsync:(id)arg1 completionHandler:(id)arg2;
- (id)createDeviceWithType:(id)arg1 runtime:(id)arg2 name:(id)arg3 error:(id *)arg4;
- (void)createDeviceAsyncWithType:(id)arg1 runtime:(id)arg2 name:(id)arg3 completionHandler:(id)arg4;
- (BOOL)unregisterNotificationHandler:(unsigned long long)arg1 error:(id *)arg2;
- (void)sendNotification:(id)arg1;
- (unsigned long long)registerNotificationHandlerOnQueue:(id)arg1 handler:(id)arg2;
- (unsigned long long)registerNotificationHandler:(id)arg1;
...
- (void)_monitorProfilesSubDirectory:(int)arg1 path:(id)arg2 updateBlock:(id)arg3;
- (void)_monitorProfilesDirectory:(int)arg1 path:(id)arg2 forSubDirectory:(id)arg3 updateBlock:(id)arg4;
...
- (void *)launch_sim_set_death_handler;
- (void *)launch_sim_waitpid;
- (void *)launch_sim_spawn;
- (void *)launch_sim_getenv;
- (void *)launch_sim_bind_session_to_port;
- (void *)launch_sim_find_endpoint;
- (void *)launch_sim_register_endpoint;
- (BOOL)isAvailableWithError:(id *)arg1;
@property(readonly) BOOL available;
- (id)dyld_simPath;
